...
mlr <- rbind(sim3_model_one, sim3_model_two)

## save the MLR model [first 4 rows are model 1 then rest are 2]
write.csv(mlr, file = "/Users/aokutse/Desktop/PhD/Spring 2024/Bayesian/FinalProject/models/regression/mlr.csv", row.names = FALSE)
